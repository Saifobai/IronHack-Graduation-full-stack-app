...
//   // 🔹 Highlight then run after delay
//   const triggerFeature = (featureKey, actionFn) => {
//     setActiveFeature(featureKey);
//     setTimeout(() => {
//       actionFn();
...
//   // 🔹 AI Actions
//   const handleSummarize = async (link = videoLink) => {
//     try {
//       setHighlightCard("summarize");
//       setIsLoading(true);
//       setLoadingTask("Summarization");
...
//   const handleHighlights = async (link = videoLink) => {
//     try {
//       setHighlightCard("highlight");
//       setIsLoading(true);
//       setLoadingTask("Highlight Generation");
...
//   const handleTranscribe = async (link = videoLink) => {
//     try {
//       setHighlightCard("transcription");
//       setIsLoading(true);
//       setLoadingTask("Transcription");
...
//   const handleViralClips = async (link = videoLink) => {
//     try {
//       setHighlightCard("clips");
//       setIsLoading(true);
//       setLoadingTask("Viral Clip Generation");
...
//   // 🔹 Helper to run intent after state is updated
...
//       // delay so React state updates before running
//       setTimeout(() => {
//         runIntent(normalized, maybeLink);
//       }, 300);
//     } else {
